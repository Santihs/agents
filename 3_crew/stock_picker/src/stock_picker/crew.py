...
# ! We create classes like this to define the structure of our data
# ! This is thanks to pydantic in order to ensure data integrity and validation
...
class StockPicker():
    ...
    def crew(self) -> Crew:
        ...
        return Crew(
            agents=self.agents,
            tasks=self.tasks,
            # The process here is not sequential because we want to leverage the hierarchical approach for better coordination
